...
/* ==========================================================================
	...
	// Dropdowns
	jQuery('body').on('click', '.site-header-collapsed .dropdown', function () {
	...
	jQuery('body').on('click', '.mobile-menu-left-overlay', function () {
	...
	// Right mobile menu
	jQuery('body').on('click', '.site-header .burger-right', function () {
...
/* ========================================================================== */
	...
	$('#show-hide-sidebar-toggle').on('click', function()
	{
		if (!$('body').hasClass('sidebar-hidden')) {
			...
			$('.page-content').addClass('nomargin');
		} else {
			$('body').removeClass('sidebar-hidden');
			$('.page-content').removeClass('nomargin');
		}
	});
});
